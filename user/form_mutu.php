...
?>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<div class="box-content">
				<form class="form-horizontal" method="post" action="save_form_mutu.php" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="controls">
							...
							<!-- <input type="file" class="input-xlarge focused" id="customFile"> -->
	...
	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="icon-file-alt"></i><span class="break"></span>Form Mutu</h2>
				<div class="box-icon">
					<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
					<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
					<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<?php
						...
						if($_SESSION['id_hak_akses']=="WP" || $_SESSION['id_hak_akses']=="PS"){ 
							$sql = "SELECT * FROM form_mutu ORDER BY kode";
						}else{
							$sql = "SELECT * FROM form_mutu WHERE kode LIKE '%.".$_SESSION['id_hak_akses'].".%' ORDER BY kode";
						}
					...
					<tr>
						...
						<?php if($_SESSION['id_hak_akses']=="WP"){ ?>
						<td class="center">
							<a class="btn btn-info" href="edit_form_mutu.php?uID=<?php echo $row['id']; ?>">
								<i class="halflings-icon white edit"></i>  
							</a>
							<a class="btn btn-danger" onclick="return confirmDel()" href="delete_form_mutu.php?delID=<?php echo $row['id'];?>">
								<i class="halflings-icon white trash"></i> 
							</a>
							<a class="btn btn-secondary" href="history.php?kode=<?php echo $row['kode']; ?>&idD=<?php echo $row['id']; ?>&idK=4">
						...
						<?php }else{ ?>
						<td class="center">
							<a class="btn btn-info" href="perubahan_dokumen.php?dID=<?php echo $row['id']; ?>&kID=4">
								<i class="halflings-icon white edit"></i>  
							</a>
						</td>
						<?php } ?>
