...
if(isset($_GET['usulan'])){
	...
	$sql ="SELECT * FROM prosedur_kerja where id = '$userID'";
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Update Prosedur Kerja</h2>
						<div class="box-icon">
							<a href="prosedur_kerja.php" class="btn-close"><i class="halflings-icon white remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" method="post" action="update_prosedur_kerja.php" enctype="multipart/form-data">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" name="txtklausul" id="focusedInput" type="text" placeholder="Klausul"
								  value="<?php echo $klausul; ?>">
								</div>
							  </div>
							  <div class="control-group">
								...
								<div class="controls">
								  ...
								  <!-- <input class="input-xlarge focused" name="txtfile" id="focusedInput" type="text" placeholder="File"
								  value="<?php echo $file; ?>"> -->
								</div>
							  </div>
							 <!--  <div class="control-group">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
									<select name="id_prosedur">
										...
										foreach($data as $isi){
											if($id_pk==$isi['id']){
												echo "<option value=$isi[id] selected='selected'>$isi[kode_prosedur]</option>";
											}else{
