...
if(isset($_GET['usulan'])){
	...
	$sql ="SELECT * FROM form_mutu where id = '$userID'";
...
<?php
	...
	get_header();
	get_sidebar();
	get_bread_edit_form_mutu();
?>
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Update Form Mutu</h2>
						<div class="box-icon">
							<a href="form_mutu.php" class="btn-close"><i class="halflings-icon white remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" method="post" action="update_form_mutu.php" enctype="multipart/form-data">
							<fieldset>
